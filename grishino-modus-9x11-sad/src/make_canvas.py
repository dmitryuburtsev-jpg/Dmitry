...
new = {'v': 3, 'createdOnFiles': {'v': 1, 'at': datetime.datetime.now(datetime.timezone.utc).strftime('%Y-%m-%dT%H:%M:%SZ')},
       'title': 'Гришино-Модус 9х11 · терраса в сад', 'launch': {'view': 'canvas'}, 'pages': [], 'boards': boards,
       'order': c['order'] + ['Check.dc.html'],
       'notes': {'title': {'kind': 'title1', 'maxW': 4480, 'text': 'Гришино-Модус 9х11 · терраса в сад: дом 9,0×11,5 развёрнут террасой в сад, вход от калитки; баня, генплан, сети, газ, смета', 'w': 240, 'x': -400, 'y': -300}},
       'designSystems': []}
