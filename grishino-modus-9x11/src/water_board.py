...
rep('<div>3. Ввод в подполье дома — у правой стены, дальше труба идёт по утеплённому подполью к бойлерной в левом углу у улицы. Автоматика и гидроаккумулятор — в бойлерной.',
    '<div>3. Траншея В1 от кессона идёт прямо к правой стене дома (12,5 м), ввод в подполье — в 6,5 м от тыльной оси Г; дальше ≈ 5,5 м по утеплённому подполью в котельную (пом. 7 у тыльной стены). Автоматика и гидроаккумулятор — в котельной, до санузла и кухни 1–3 м. Под линией канализации бани (у КК-1) В1 проходит в стальном футляре по 5 м в обе стороны: водопровод глубже канализации.')
...
items = [
    ...
    ('Труба ПНД Ø32 PN16: кессон → ввод в подполье (13 м) + по подполью до котельной (6 м) в утеплении с греющим кабелем', 'компл', 1, 11000),
