...
from calc import *
import iso, re
s = src('Visual.dc.html').replace('Дизайн-проект участка · д. Гришино', 'Гришино-Модус 9х11 · д. Гришино')
...
for a, b in [('Дом 85 м²: вход и крыльцо со стороны калитки, терраса в сад', 'Дом каркасный 9,0×11,5 м, 94,3 м²: терраса в сад, вход со стороны калитки'),
