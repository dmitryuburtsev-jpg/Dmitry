...
rep('<div>3. Ввод в подполье дома — у правой стены, дальше труба идёт по утеплённому подполью к бойлерной в левом углу у улицы. Автоматика и гидроаккумулятор — в бойлерной.',
    '<div>3. Траншея В1 от кессона идёт прямо к правой стене дома (12,5 м), ввод в подполье — прямо под котельной, в 5,0 м от уличного торца и в 2,4 м от крыльца входа. Автоматика и гидроаккумулятор — в котельной; до санузлов 1 и 2 этажа (стояк в котельной) и кухни 1–3 м. Газовый ввод — в 1,1 м от В1. Под линией канализации бани (у КК-1) В1 проходит в стальном футляре по 5 м в обе стороны: водопровод глубже канализации.')
...
items = [
    ...
    ('Труба ПНД Ø32 PN16: кессон → ввод в подполье под котельной (13 м) + подъём в котельную, в утеплении с греющим кабелем', 'компл', 1, 9000),
