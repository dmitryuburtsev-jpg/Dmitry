...
| `src/` | Генератор: `calc.py` — геометрия и расчёты сетей, `plan.py` — планы 1 и 2 этажа, `*_board.py` — листы, `original/` — исходный генплан |
...
| Вариант | Итог |
|---|---|
| Правая стена прихожей 2: простенок 1,35 м, дверь 860 с коробкой ≈ 0,96 м помещается, по 0,2 м до углов; прихожая работает тамбуром | **принят**: металлическая дверь 860, крыльцо 1,0 × 1,6 на 2 сваях под козырьком, от калитки ≈ 13 м |
...
| Только Д-1 с террасы | ≈ 17 м вокруг дома — неудобно; Д-1 остаётся вторым входом из сада |

## Сети

| Сеть | Решение |
|---|---|
| К1 | Мокрые точки у правой стены и одна над другой (котельная — санузел 2 этажа). Коллектор ≈ 8 м под полом вдоль правой стены, выпуск −0,85 через уличный торец, 3,3 м до КК-4 на магистрали. Линия бани — 3,0 м от дома, 10,0 м от скважины, 2,1 м от свай крыльца. Вход в ЛОС −1,39 («Лонг», до −1,40). |
| В1 | Траншея 12,5 м от кессона прямо под котельную; стальной футляр 10 м под К1 бани. |
| Газ | ШГ левее калитки; Г1 ПЭ Ø32 14,8 м на −1,55 (под К1 с зазором 0,43 м) в 2,0 м от дома, 1,0 м от К1 бани, 1,1 м от В1; ввод через правую стену прямо в котельную. |
